...
# --- EXTERNAL API (utils) TESTS ---

def test_fetch_product_success():
    # Pretend the real API returns a good product
    ...
    assert result['brands'] == 'Tropicana'

def test_fetch_product_not_found():
    # Pretend the API says product does not exist
    fake_response = MagicMock()
    fake_response.status_code = 200
...
def test_fetch_product_api_error():
    # Pretend the API crashes (no internet etc)
...
def test_cli_view_all(capsys):
    # Simulate user pressing 1 then 6 to exit
    fake_response = MagicMock()
...
def test_cli_add_item(capsys):
    # Simulate user pressing 2 to add item then 6 to exit
    fake_response = MagicMock()
...
def test_cli_import_barcode_found(capsys):
    # Simulate user pressing 3, entering barcode, external product found, adds it
...
def test_cli_import_barcode_not_found(capsys):
    # Simulate barcode not found in external API
...
def test_cli_update_item():
    # Simulate user pressing 4 to update item
    fake_response = MagicMock()
...
def test_cli_delete_item():
    # Simulate user pressing 5 to delete item
    fake_response = MagicMock()
